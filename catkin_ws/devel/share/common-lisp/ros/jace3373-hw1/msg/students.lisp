...
(cl:in-package jace3373-hw1-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <students>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'students)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jace3373-hw1-msg:<students> is deprecated: use jace3373-hw1-msg:students instead.")))

(cl:ensure-generic-function 'first_name-val :lambda-list '(m))
(cl:defmethod first_name-val ((m <students>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jace3373-hw1-msg:first_name-val is deprecated.  Use jace3373-hw1-msg:first_name instead.")
  (first_name m))

(cl:ensure-generic-function 'last_name-val :lambda-list '(m))
(cl:defmethod last_name-val ((m <students>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jace3373-hw1-msg:last_name-val is deprecated.  Use jace3373-hw1-msg:last_name instead.")
  (last_name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <students>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jace3373-hw1-msg:age-val is deprecated.  Use jace3373-hw1-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'score-val :lambda-list '(m))
(cl:defmethod score-val ((m <students>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jace3373-hw1-msg:score-val is deprecated.  Use jace3373-hw1-msg:score instead.")
  (score m))
