...
(cl:defmethod cl:initialize-instance :after ((m <students>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'students)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name beginner_tutorials-msg:<students> is deprecated: use beginner_tutorials-msg:students instead.")))
